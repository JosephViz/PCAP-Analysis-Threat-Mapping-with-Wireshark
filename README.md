...
<img src="https://i.imgur.com/SKNIBaz.png" height="40%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Deeper inpection reveals IPV4, TCP, & SMB2 Usage:  <br/>
<img src="https://i.imgur.com/kgIxqco.png" height=80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Reviewing the conversations-level traffic statistics to identify top talkers(.130,.131,.133) <br/>
<img src="https://i.imgur.com/n64UHGi.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Traffic analysis for 10.0.0.130; TCP connection was successful over port 445:  <br/>
<img src="https://i.imgur.com/V5KCs84.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
TCP Stream for packet; Identified hostname, NTLMSSP :  <br/>
<img src="https://i.imgur.com/PPwMlnN.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Network Query request capture, $ADMIN Request Successful  <br/>
<img src="https://i.imgur.com/zAzFApu.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Traffic Analysis for 10.0.0.131(MARKTING-PC):  <br/>
<img src="https://i.imgur.com/f3bAUbT.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Lateral movement attempt from 10.0.0.130 to 10.0.0.131: <br/>
<img src="https://i.imgur.com/nmLURjx.png" height="40%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Analysis of SMB2 traffic showing remote file access:  <br/>
<img src="https://i.imgur.com/Kniiluh.png" height=80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
